  ...
  return (
    <section className="event-slider">
      ...
      {props.slides.map((event, idx) => {
        return (
          <div
            className={idx === current ? "event-slide-active" : "event-slide"}
          >
...
function EventCard({ event }) {
  return (
    <div
      ...
      style={{ backgroundColor: "#c4c4c4", borderRadius: "32px" }}
    >
      ...
      <div className="event-media">
        <img className="event-image" src={event.media} alt="logo"></img>
      </div>
    </div>
  );
}
